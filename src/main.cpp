...
uint256 hashGenesisBlock("0x000000006ac77655e8fd6abb94d27c790fb14349ad6ff7956006f7b09ac8faff");
...
const string strMessageMagic = "rainbowcoin Signed Message:\n";
...
static const int64 nTargetTimespan = 3456000;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x000000006ac77655e8fd6abb94d27c790fb14349ad6ff7956006f7b09ac8faff");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis block
        const char* pszTimestamp = "Mtgox BTCUSD 2014-02-13T22:41:02; last:461.20 buy:463.91 sell:465.51";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1392331286;
        block.nBits    = 486604799;
        block.nNonce   = 335184639;
        ...
        assert(block.hashMerkleRoot == uint256("0xa82d246866fa7ad8dc4e8aa8af9dac1c784c27fda515516149af8de67b5bcdc9"));
        block.print();
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("rainbowcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("rainbowcoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("rainbowcoinMiner started\n");
    ...
    try { loop {
        ...
        printf("Running rainbowcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("rainbowcoinMiner terminated\n");
        throw;
    }
}
